...
export default function Footer() {
  return (
    <footer className="w-full border-t bg-black text-white py-12 md:py-16">
        ...
        <div className="grid grid-cols-2 gap-8 md:col-span-2">
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/categories/men" className="hover:text-gray-300 transition-colors">
                  Men
                </Link>
              </li>
              <li>
                <Link href="/categories/women" className="hover:text-gray-300 transition-colors">
                  Women
                </Link>
              </li>
              <li>
                <Link href="/categories/unisex" className="hover:text-gray-300 transition-colors">
                  Unisex
                </Link>
              </li>
            </ul>
